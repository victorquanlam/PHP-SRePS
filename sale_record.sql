...
--
-- Host: localhost
-- Generation Time: Sep 27, 2018 at 09:46 AM
...
(100006, '2018-09-27', 'Panadol', 1, 0, 'cash', 'paid', 12),
(100007, '2018-09-27', 'Panadol', 3, 0, 'card', 'paid', 12);
...
--
ALTER TABLE `sale`
  MODIFY `sale_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100008;
